...
from config.settings import POSTGRES_DB, POSTGRES_USER, POSTGRES_PASSWORD, POSTGRES_HOST, POSTGRES_PORT
from models.users import metadata as users_metadata
from models.store import metadata as store_metadata
...
target_metadata = [users_metadata, store_metadata]
